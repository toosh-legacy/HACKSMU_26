/**
 * Converts a KnowledgeGraph into a Graphology graph for Sigma.js rendering.
 *
 * Handles:
 * - Hierarchy-based positioning (folders spread wide, children near parents)
 * - Community/cluster-based positioning via golden-angle distribution
 * - Node sizing scaled to graph density
 * - Node mass for ForceAtlas2 physics
 * - Edge coloring by relationship type
 * - Depth/label filtering
 */
import Graph from 'graphology';
import type { NodeLabel, KnowledgeGraph, SigmaNodeAttributes, SigmaEdgeAttributes } from './types';
...
export const knowledgeGraphToGraphology = (
  ...
  // Position structural nodes in wide radial pattern
  ...
  // BFS from structural nodes — parent always positioned before child
...
/** Filter nodes by label visibility */
